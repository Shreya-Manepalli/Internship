        ...
        for filename in files:
            if filename.endswith('.pdf'):
                ...
                for i, page in enumerate(doc):
                    ...
                    cropped_chunks = crop_image_into_chunks(output_path)
                    for j, chunk in enumerate(cropped_chunks):
                        chunk.save(os.path.join(page_output_subfolder_path, f'page_{i+1}_chunk_{j+1}.jpg'))
