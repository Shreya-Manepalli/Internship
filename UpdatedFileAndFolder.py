...
def pdf_2_excel(pdf_path, excel_path, output_path):
    ...
    write_to_excel("NCR-No.", 2 + start_point, 1, "result.xlsx")
    write_to_excel("Design Organization Drawing and issue", 3 + start_point, 1, "result.xlsx")

    z = 0

    for z in range(3):
        write_to_excel(table1[z], z+1 + start_point, 2, "result.xlsx")

    write_to_excel("Item No.", 4 + start_point, 1, "result.xlsx")
    write_to_excel("Defect Type", 4 + start_point, 2, "result.xlsx")
    write_to_excel("Charact. No.", 4 + start_point, 3, "result.xlsx")
    write_to_excel("Serial numbers affected", 4 + start_point, 4, "result.xlsx")
    write_to_excel("Description of Nonconformance", 4 + start_point, 5, "result.xlsx")
