...
def table_2_excel(pdf_path, excel_path, output_path):
    ...
    # Setting up workbook
    write_to_excel("Material No.", 1 + start_point, 1, output_path, output_sheet_name)
    write_to_excel("NCR-No.", 1 + start_point, 2, output_path, output_sheet_name)
...
def pdf_folder_2_excel(excel_path, output_path, file_list):
    folder_path = "./path_temp"
